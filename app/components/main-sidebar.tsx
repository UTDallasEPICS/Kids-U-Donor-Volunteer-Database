            ...
            <div key={index}>
              <div className={`rounded-lg overflow-hidden ${shouldHighlight ? "bg-blue-50" : ""
                ...
                >
                  ...
                  {item.hasSubmenu && (
                    <svg
                      className={`w-4 h-4 transition-transform duration-300 ${isDropdownOpen ? "rotate-90" : ""
                        }`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                ...
                {item.hasSubmenu && item.submenuItems && (
                  <div
                    className={`overflow-hidden transition-all duration-300 ease-in-out ${isDropdownOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0"
                      }`}
                  >
