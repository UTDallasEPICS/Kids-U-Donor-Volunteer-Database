...
export default function Import() {
  ...
  const dbFields = [
      "Assigned", "Quarter", "Funder", "Funding Area", "Kids-U Program", 
      "Contact Type", "LOI Due Date", "Grant Due Date", "Open-close dates", 
      "Funding Restrictions", "Written Amount", "Amount Awarded", "Notes", "Resources", "Link for grant import"
  ];
