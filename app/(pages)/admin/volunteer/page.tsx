          ...
          <Table sx={{ minWidth: 650 }} size="small">
            <TableHead>
              <TableRow>
                ...
                {selectedColumns.includes("businessOrSchoolName") && <TableCell style={styles.tableCellHeader}>Business/School Name</TableCell>}
            ...
            <TableBody>
              {volsData?.map((volunteer) => (
                <TableRow key={volunteer.id}>
                  ...
                  {selectedColumns.includes("businessOrSchoolName") && <TableCell style={styles.tableCell}>{volunteer.businessOrSchoolName}</TableCell>}                  
                </TableRow>
              )) ?? null}
            </TableBody>
            <TableFooter>
