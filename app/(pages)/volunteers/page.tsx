  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 p-6">
      <div className="flex items-center justify-between mb-8">
        ...
        <Image src={logo} alt="Kids University Logo" width={150} height={65} className="object-contain" />
      </div>
              ...
              {upcomingEvents.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <p className="text-sm text-gray-600 mb-6 max-w-md leading-relaxed">
                    Check back soon for exciting volunteer opportunities. Events are posted regularly and we&apos;d love
                    to see you there!
                  </p>
                  <button
                    onClick={() => (window.location.href = "/volunteers/registration")}
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="bg-gradient-to-br from-[#2f4b7c] to-[#4a6fa5] rounded-2xl p-6 text-white shadow-md">
            ...
            <p className="text-sm opacity-95 leading-relaxed mb-3">
              Have questions or need assistance? Our team is here to help you make the most of your volunteer
              experience.
            </p>
            <a
