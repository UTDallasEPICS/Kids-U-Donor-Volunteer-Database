  ...
  const Form = () => (
    <div className="space-y-6">
      <form className="space-y-4">
        ...
        <div className="flex flex-col">
          <label htmlFor="time" className="mb-1 text-gray-700"> Time of Event </label>
          <input type="time" id="time" name="time" className="border-2 border-blue-400 rounded-md p-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500" required></input>
        ...
        <div className="flex flex-col">
          ...
          <select id="address" name="address" className="border-2 border-blue-400 rounded-md p-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        <div >
          <input type="submit" id="submit" name="submit" className="w-full text-gray-800 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-md cursor-pointer transition-all duration-200 focus:ring-offset-1" ></input>
        </div>
