...
export default function LoginPage(): JSX.Element {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.requires2FA) {
        router.push(
          `/verification/verify-2fa?email=${encodeURIComponent(email)}&password=${encodeURIComponent(password)}`
        );
        return;
      }
    ...
    <div className="min-h-screen w-full flex">
      ...
      >
        ...
        <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-10 border border-gray-100">
          {/* Welcome Text */}
          <h1 className="text-4xl text-[#2f4b7c] font-light text-center mb-10">Welcome to Kids-U</h1>
            ...
            <div>
              ...
              <div className="text-right mt-3">
                <a
                  ...
                  className="text-[#4a6fa5] text-sm font-medium hover:text-[#2f4b7c] transition-colors"
                >
                  Forgot Password?
                </a>
              </div>
