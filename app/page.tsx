          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="text-right mt-3">
                <a href="#" className="text-[#4a6fa5] text-sm font-medium hover:text-[#2f4b7c] transition-colors">
                  Forgot Password?
                </a>
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-[#4a6fa5] to-[#2f4b7c] text-white text-lg font-medium py-3.5 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all duration-200 mt-6"
            >
              Sign In
            </button>
            ...
            <div className="text-center pt-6 border-t border-gray-100 mt-6">
              ...
              <a href="#" className="text-[#4a6fa5] text-sm font-semibold hover:text-[#2f4b7c] transition-colors">
                Sign Up
              </a>
            </div>
          </form>
